...
#### 1º - Compile the mandatory or bonus files
...
#### 2º - BUFFER_SIZE can be specified at compilation to override the default BUFFER_SIZE
...
#### 3º - Execution with one or multiple file descriptors/standard input
```bash
./a.out [text.txt]
